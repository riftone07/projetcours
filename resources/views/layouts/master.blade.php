...
<head>
    ...
    <title>Bienvenue | @yield('title') </title>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{ route('welcome') }}">
                    <i data-feather="users"></i><span class="menu-title text-truncate" data-i18n="Email">Employes</span>
                </a>
            </li>
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{ route('master') }}">
                    <i data-feather="check-square"></i><span class="menu-title text-truncate" data-i18n="Email">Criteres</span>
                </a>
            </li>
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="app-email.html">
                    <i data-feather="mail"></i><span class="menu-title text-truncate" data-i18n="Email">Evaluations</span>
                </a>
            </li>
